    ...
    work: {
      ...
      projects: [
        ...
        },
        {
          category: 'ecommerce',
          name: 'Sknups Fashion',
          video: '/videos/sknups-fashion.mp4',
          tags: ['Fashion','Custom Made','Sutra','Kulit Domba'],
          icon: '✨',
          desc: 'Dunia fashion tanpa batas — dari sutra premium dan kulit domba lembut hingga pakaian custom made eksklusif. Sknups Fashion menangkap tren terkini dengan koleksi yang berani, sensual, dan tak terduga. Ini bukan sekadar pakaian. Ini pernyataan.',
        },
        {
          category: 'fnb',
          name: 'Summer Moon Coffee',
          video: '/videos/summer-moon.mp4',
        ...
        },
        {
          category: 'creative',
          name: 'Mancini & Co',
          video: '/videos/mancini-co.mp4',
          tags: ['Perhiasan','Cincin','Mewah','Pernikahan'],
          icon: '💍',
          desc: 'Toko perhiasan eksklusif dengan estetika abadi — menghadirkan koleksi cincin eksotis yang dirancang untuk momen paling berharga dalam hidup. Dari pernikahan mewah hingga acara gala, setiap karya Mancini & Co adalah mahakarya yang diwariskan.',
        },
        {
          category: 'events',
    ...
    work: {
      ...
      projects: [
        ...
        },
        {
          ...
          name: 'Sknups Fashion',
          video: '/videos/sknups-fashion.mp4',
          tags: ['Fashion','Custom Made','Silk','Lambskin'],
          icon: '✨',
          desc: 'Fashion without limits — from liquid silk and buttery lambskin to one-of-a-kind custom pieces. Sknups captures the bleeding edge of global trends with collections that are bold, sensual, and utterly unexpected. This isn\'t clothing. It\'s a statement.',
        },
        {
          category: 'fnb',
          name: 'Summer Moon Coffee',
        ...
        },
        {
          ...
          name: 'Mancini & Co',
          video: '/videos/mancini-co.mp4',
          tags: ['Jewellery','Rings','Luxury','Wedding'],
          icon: '💍',
          desc: 'An exclusive jewellery house built around timeless elegance — showcasing exotic rings crafted for life\'s most precious moments. From opulent weddings to black-tie galas, every Mancini & Co piece is an heirloom waiting to be worn.',
        },
        {
          category: 'events',
          name: 'Relats Automotive',
