...
export const translations = {
  ID: {
    ...
    hero: {
      ...
      stats: [['500+','Website Terkirim'],['98%','Kepuasan Klien'],['3×','Rata-rata Peningkatan Konversi'],['5★','Rating Rata-rata']],
    },
    about: {
      ...
      why: [
        { icon:'⚡', title:'Terkirim Cepat', desc:'Landing page 3–5 hari. Website lengkap 7–14 hari. Kami bergerak cepat tanpa mengorbankan kualitas.' },
        { icon:'🎨', title:'Benar-benar Kustom', desc:'Nol template. Setiap situs dirancang dari kanvas kosong, dibangun khusus untuk brand Anda.' },
        { icon:'📈', title:'Dibangun untuk Konversi', desc:'Cantik saja tidak cukup. Kami mengoptimalkan setiap layout, CTA, dan alur untuk hasil bisnis nyata.' },
        { icon:'🛠', title:'Tim Full-Stack', desc:'Desain, frontend, backend, SEO — semua dalam satu atap. Satu kontak, end-to-end.' },
        { icon:'💬', title:'Selalu Bisa Dihubungi', desc:'Chat langsung via WhatsApp. Tidak ada antrian tiket, tidak menunggu berhari-hari untuk balasan.' },
        { icon:'🔒', title:'Dukungan 30 Hari', desc:'Setiap proyek mencakup dukungan pasca-peluncuran. Kami menemani Anda bahkan setelah situs live.' },
      ],
    },
  ...
  EN: {
    ...
    hero: {
      ...
      stats: [['500+','Websites Delivered'],['98%','Client Satisfaction'],['3×','Avg. Conversion Lift'],['5★','Average Rating']],
    },
    about: {
